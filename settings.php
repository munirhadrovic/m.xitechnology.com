<?php
	$adresa="4600 Wesley Court Mason, OH 45040 "; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5132045822;// Broj koji se poziva na dugme CALL US
